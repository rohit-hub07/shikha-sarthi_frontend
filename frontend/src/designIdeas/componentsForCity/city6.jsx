...
const City6 = () => {
  return (
    <div className="pb-5 mb-2 bg-body-secondary">
      ...
      <p>
        T&Cs apply: *Flat 10 years for products & 1 year for services. For full
        scope on warranty, please visit www.livspace.com/in/service | ^For
        select finishes on modular products
      </p>
    </div>
  );
};
