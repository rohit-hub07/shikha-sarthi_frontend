...
// default data
const defaultData = {
  title: "प्रातःकालीन प्रार्थना",
  description: `प्रातःकालीन प्रार्थना से दिन की शुरुआत सकारात्मक विचारों के साथ होती
          है। इससे विद्यार्थियों में अनुशासन, एकाग्रता और नैतिक मूल्यों का विकास
          होता है। प्रार्थना के माध्यम से मन शांत रहता है और पढ़ाई में ध्यान
          केंद्रित करने की प्रेरणा मिलती है।`,
  imageUrl: "Morning-prayer-img.jpg",
...
const Prayer = () => {
  ...
  useEffect(() => {
    const fetchPost = async () => {
      try {
        const response = await fetch(`${backend_url}/api/posts?category=prayer`);
