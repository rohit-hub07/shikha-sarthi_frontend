...
// default data
const defaultData = {
  title: "प्रातःकालीन पी.टी.",
  description: `प्रातःकालीन पी.टी. (शारीरिक प्रशिक्षण) से बच्चों का शरीर स्वस्थ और
          चुस्त रहता है। इससे अनुशासन, टीम भावना और एकाग्रता का विकास होता है।
          नियमित व्यायाम से बच्चे दिनभर ऊर्जावान और सक्रिय रहते हैं।`,
  imageUrl: "Exercise-img.png",
...
const PiTi = () => {
  ...
  useEffect(() => {
    const fetchPost = async () => {
      try {
        const response = await fetch(`${backend_url}/api/posts?category=piti`);
    ...
    <div className="mt-4 mb-4">
      ...
      <div className="row g-3">
        <div className="col-12 col-md-6 col-lg-5">
          <Carousel
            images={[
              "/physical_training1.jpeg",
              "/physical_training2.jpeg",
              "/running.jpeg",
              "/running2.jpeg",
              "/Exercise-img.png",
              postDetail.imageUrl
