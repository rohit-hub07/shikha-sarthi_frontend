...
// default data
const defaultData = {
  title: "विद्यालय में वृक्षारोपण",
  description: `विद्यालय में वृक्षारोपण से विद्यार्थियों में पर्यावरण के प्रति
          जागरूकता बढ़ती है। इससे स्वच्छ वायु, हरियाली और स्वस्थ वातावरण का
          महत्व समझ में आता है। यह गतिविधि बच्चों में जिम्मेदारी और प्रकृति से
          प्रेम की भावना विकसित करती है।`,
  imageUrl: "Planting-img.jpg",
...
const Planting = () => {
  ...
  useEffect(() => {
    const fetchPost = async () => {
      try {
        const response = await fetch(`${backend_url}/api/posts?category=planting`);
